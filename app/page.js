  ...
  return (
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      <div className="max-w-5xl mx-auto text-center space-y-8">
        <h1 className="text-5xl md:text-7xl lg:text-8xl mb-6 gradient-title">Welcome to Shajara.<br/> Lets reflect on the day</h1>
        <p className="text-lg md:text-xl text-orange-800 mb-8">
          Capture your thoughts,Lets get Insights on your day,this is a safe space.
        </p>
        ...
        <Card className="bg-gradient-to-r from-orange-100 to-amber-100">
          <CardContent className="p-12 text-center">
            <h2 className="text-3xl font-bold text-orange-900 mb-6">
              Start your Shajara Journey Today
            </h2>
